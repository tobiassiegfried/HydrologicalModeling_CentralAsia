...
* Make sure that the maps projection is in UTM ([How to change the projection of a project](#section-change-project-projection-qgis)).   
...
You will find a DEM raster layer in the ./learningFiles directory of your sample catchment ready to start. Load the DEM into your QGIS project and save the project [how to](#section-quick-guides-load-dem). For the hydrological analysis, the DEM needs to be in UTM. Look up the projection of your DEM layer and reproject to UTM if necessary [how to](#section-quick-guides-verify-projection-reproject).    
