...
t2m_meanMonthlyClimate_CHELSA <- 
  raster::brick('../HydrologicalModeling_CentralAsia_Data/CentralAsiaDomain/CHELSA_V1.2.1/t2m_climatology/t2m_climatology_CA.tif/')
...
pbcorr_pr_meanMonthlyClimate_CHELSA <- 
  raster::brick('../HydrologicalModeling_CentralAsia_Data/CentralAsiaDomain/CHELSA_V1.2.1/pbcorr_tp_climatology/CHELSA_V12.nc', varname = "corr_P_monthly")

pbcorr_pr_meanMonthlyClimate_CHELSA <- raster::crop(pbcorr_pr_meanMonthlyClimate_CHELSA,aoi_CentralAsia_LatLon)
