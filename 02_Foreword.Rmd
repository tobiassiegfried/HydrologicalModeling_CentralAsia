...
## Day 3: Introduction to hydrological modeling and geospatial data {.unnumbered}
Read Chapters [6.2](#section-rsminerve-why-model-introduction) and [6.3](#section-general-modelling-process) and do the exercise on the linear reservoir model.   
