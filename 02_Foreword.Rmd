...
**Oasis between Samarkand and Buchara. Source: Tobias Siegfried.**
...
With everything that is presented, the focus is on the use of open source and free software. For data preparation and analysis as well as for water balance and empirical modeling, R and RStudio are utilized [@R-2013; @RStudio-2020]. For the processing of geographic data, workflows in QGIS are demonstrated [@QGIS_software]. For hydrological-hydraulic modeling, the free RSMinerve is utilized which is a environment for the modeling of free surface runoff flow formation and propagation [@rsminerve_um; @rsminerve_tm].
