...
Read [Part I](#Part1_Hydrological_Systems) of the course book.
/*[Chapter 1: A short history of Water in Central Asia](#ShortHistory) and [Chapter 2: Hydrological Systems in Central Asia](#HydrologicalSystems) in the course book. */

```{r, eval = "html", label="exercise0", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex0"> 
<h3 class = "right">Ex0</h3> 
<h3 class= "left">Introductory reading and software installation</h3> 
<p>Read Part I of the book and make sure you have the required software (see prerequisites above) installed and working.</p>
</div>')
```
...
Read [Chapter 4](#Part2-Applied-Modeling) and do the exercise on catchment characterization, i.e. do a catchment characterization of your sample catchment in QGIS or in R.
...
Read the [Data Chapter](#Chapter-DATA). As a preparation to the HBV model, read Chapter [6.2](#section-rsminerve-why-model-introduction) and do the exercise on the linear reservoir model given below.

```{r, eval = "html", label="exercise-linear-reservoir", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex2"> 
<h3 class = "right">Ex2</h3> 
...
** TODO: This exercise could be made more specific**\  
...
```{r, eval = "html", label="exercise-foster-R", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex3"> 
<h3 class = "right">Ex3</h3> 
<h3 class = "left">Exercise: Work on your R skills</h3> 
<p>Choose an R tutorial to work on from the <a href="https://tobiassiegfried.github.io/HydrologicalModeling_CentralAsia/sectin-appendix-solutions.html#section-open-resrouces-learning-R">Appendix</a> which suits your skills. If you are already fluent in R, work on your visualization skills in R by producing nice plots of your sample catchment which you may include in the final presentation on the last day of the workshop. You may let yourselves be inspired by the R code supplied with this book.</p>
</div>')
```
...
Read [Chapter 6.5 on the HBV model](#section-hbv-model) and the pre-requisite reading listed therein. It is recommended to do the tasks suggested in the course book to get more familiar with RS Minerve.\

```{r, eval = "html", label="exercise-hbv-model", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex4"> 
<h3 class = "right">Ex4</h3> 
<h3 class = "left">Exercise: Implement your catchment in RS Minerve</h3> 
<p>Implement your catchment using HBV models based on the catchment characterization that you performed on day 2 and the GIS layers that you prepared on day 3.</p>
</div>')
```
...
```{r, eval = "html", label="exercise-hbv-model-cal", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex5"> 
<h3 class = "right">Ex5</h3> 
<h3 class = "left">Exercise: Calibrate and validate your RS Minerve model</h3> 
<p>Calibrate and validate your RS Minerve model.</p>
</div>')
```
...
```{r, eval = "html", label="exercise-abstract-submission", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex6"> 
<h3 class = "right">Ex6</h3> 
<h3 class = "left">Exercise: Submit an abstract for the final conference</h3> 
...
```{r, eval = "html", label="exercise-finalize-presentation", results='asis', echo=FALSE, purl=FALSE}
cat('
<div class = "exercise" <div class = "exercise" id="ex7"> 
<h3 class = "right">Ex7</h3> 
<h3 class = "left">Exercise: Finalize presentation</h3> 
