...
### EE: Register for an account {#section-register-with-earth-explorer}
...
### EE: Download SRTM data for a selected region {#section-earth-explorer-download-srtm}
...
### The QGIS window - overview {#section-qgis-window-overview}
...
### QGIS: Saving a new QGIS project {#section-saving-a-new-qgis-project}
...
### QGIS: Change the projection of the QGIS project {#section-change-project-projection-qgis}
...
### QGIS: Install and activate plugins in QGIS3 {#section-install-and-activate-plugins-in-QGIS3}
...
### GQIS: Managing panels visibility in QGIS {#section-managing-panels}
...
### QGIS: Loading public background maps {#section-loading-public-background-layers}
...
### QGIS: Zoom to layer {#section-zoom-to-layer}
...
### QGIS: Import SRTM layers using the SRTM plugin {#section-srtm-plugin}
...
### QGIS: Merge SRTM tiles to a single layer {#section-merge-srtm-tiles}
...
### Add vector layer to QGIS {#section-add-vector-layer-to-qgis}
...
### Change color of a vector layer {#section-change-color-of-vector-layer}
