...
### QGIS: Edit Junctions layer {#appendix-section-graphical-edit-junctions .unnumbered}

Select the Junctions layer and toggle manual editing by clicking on the yellow pen (\@ref(fig:qgis-edit-junctions-1)).

```{r qgis-edit-junctions-1, echo=FALSE, out.width="90%", fig.align="center", fig.cap="Manually edit the layer with the river junctions, step 1: Toggle layer editing."}
...
### Exercise on Linear Reservoir modelling {#section-appendix-solutions-exercise1 .unnumbered}
#### Task 1 {#solution-task1-experimental-setup .unnumbered}  
...
##### Where will you get the water from and can you re-use it after the experiment? { .unnumbered}
This depends on your situation.   

Back to the [recap section](#section-rsminerve-why-model-introduction)


#### Task 2 {#solution-task2-perform-experiment .unnumbered}
...
#### Task 3 {#solution-task3-simulate .unnumbered}
...
#### Task 4 {#solution-task4-think .unnumbered}
ToDo       
...
### Exercise on creating GIS layers for import to RS Minerve { .unnumbered}

#### GIS layers for Chon Kemin {#solution-gis-layers-chonkemin .unnumbered}
Double-click on the DEM (./STUDENTS_CaseStudyPacks/CHU/15149_ChonKemin/DEM/ChonKemin_Basin_DEM_clipped_raw.tif) in the Layers panel of the QGIS window. Under the information tab you'll see the minimum and maximum elevation of the DEM tile (980 - 4549 masl). Choose the intervals for the elevation bands based on the elevation range in the catchment. 
The input layers to the QGIS process modeler are ./STUDENTS_CaseStudyPacks/CHU/15149_ChonKemin/Basin/15149_ChonKemin_Basin.shp and from ./STUDENTS_CaseStudyPacks/CHU/15149_ChonKemin/DEM/ChonKemin_Basin_DEM_clipped_raw.tif into your QGIS project. 



### Exercises on the HBV model {#section-appendix-solutions-hbv-exercises .unnumbered}

#### Exercise: Driving forces of the HBV model {#section-appendix-solutions-hbv-driving-forces .unnumbered}
...
#### Exercise - HBV model states {#section-appendix-solutions-hbv-parameters-states .unnumbered}
...
#### Exercise: Common difficulties in model calibration {#section-appendix-solutions-common-calibration-issues .unnumbered}
...
#### Exercise: Strategies to overcome some of the model calibration difficulties {#section-appendix-solutions-strategies-for-issues .unnumbered}
...
#### Exercise: Calibrate a simple HBV model {#section-appendix-solutions-calibrated parameters .unnumbered}
