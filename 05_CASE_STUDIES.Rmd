...
cat('
<div class = "exercise" <div class = "exercise" id="ex3.1"> 
<h3 class = "right">Ex3.1</h3> 
<h3 class= "left">Exercise catchment characterization</h3> 
<p>Read through the 2 case studies in this chapter and do a catchment characterization for your sample catchments. For the catchment characterization you will plot the catchment boundaries and collect the data for the table in section 3.1.1 below.</p> 
</div>')
```
