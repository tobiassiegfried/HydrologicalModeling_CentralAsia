...
:::: {.blackbox exercise-rsminerve-linres-1=""}
...
The HBV (Hydrologiska Byråns Vattenavdelning) model is a conceptual rainfall-runoff model which is suitable for many snow-fed river catchments [@bergstrom_development_1976]. You have studied the short description of the    
