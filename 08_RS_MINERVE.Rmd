...
#### Calibration and validation of the Nauvalisoy model {#section-hbv-nauvalisoy-calibration}  
...
1. Add a comparator and a source object to your Nauvalisoy model and load river discharge measurements (filename) [how to](#section-quickguides-add-comparator-and-discharge-data). 
